...
import { PostCategoryWithPostsQueryDto } from './dto/post-category-with-posts-query.dto'
...
export class PostCategoryController {
  ...
  @ApiResponse({
    status: 200,
    description: 'SUCCESS - Успішно отримано всі категорії з постами',
  })
  @ApiOperation({ summary: 'Отримати всі категорії постів з вкладеними постами' })
  findAllWithPosts(@Query() queryDto: PostCategoryWithPostsQueryDto, @Req() req: Request) {
    return this.postCategoryService.findAllWithPosts(queryDto, req.lang)
  }
